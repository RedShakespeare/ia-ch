...
extern std::string g_not_while_blind;
extern std::string g_not_while_entangled;
extern std::string g_not_while_stuck;
extern std::string g_cannot_see_there;
extern std::string g_cannot_remove_normal_means;
extern std::string g_blocked;
extern std::string g_something_blocking_it;
