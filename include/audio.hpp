...
const std::unordered_map<std::string, SfxId> g_str_to_sfx_id_map = {
        ...
        {"chains", SfxId::chains},
        {"statue_crash", SfxId::statue_crash},
        {"glop", SfxId::glop},
        ...
        {"strange_device_activate", SfxId::strange_device_activate},
        {"strange_device_damaged", SfxId::strange_device_damaged},
...
const std::unordered_map<SfxId, std::string> g_sfx_id_to_str_map = {
        ...
        {SfxId::chains, "chains"},
        {SfxId::statue_crash, "statue_crash"},
        {SfxId::glop, "glop"},
        ...
        {SfxId::strange_device_activate, "strange_device_activate"},
        {SfxId::strange_device_damaged, "strange_device_damaged"},
