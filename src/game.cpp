...
static const std::vector<std::string> win_msg = {
        {
                "As I approach the crystal, an eerie glow illuminates the "
                "area. I notice a figure observing me from the edge of the "
                "light. There is no doubt concerning the nature of this "
                "entity; it is the Faceless God who dwells in the depths of "
                "the earth - Nyarlathotep!"
        },
