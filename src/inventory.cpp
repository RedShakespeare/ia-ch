        ...
        const bool delete_item)
{
        for (size_t i = 0; i < m_backpack.size(); ++i)
        {
                const Item* const current_item = m_backpack[i];
                                    ...
                                    const SlotId slot_id)
{
        ...
        Item* item = m_backpack[backpack_idx];
