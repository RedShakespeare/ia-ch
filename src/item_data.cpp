...
ItemData g_data[(size_t)ItemId::END];
...
void init()
{
        ...
        d.max_stack_at_spawn = 1;
        d.ranged.max_ammo = g_data[(size_t)ItemId::incinerator].ranged.max_ammo;
        ...
        d.ranged.max_ammo = g_data[(size_t)ItemId::machine_gun].ranged.max_ammo;
        ...
        d.ranged.max_ammo = g_data[(size_t)ItemId::pistol].ranged.max_ammo;
        d.native_containers.push_back(FeatureId::chest);
        d.native_containers.push_back(FeatureId::cabinet);
        d.native_containers.push_back(FeatureId::cocoon);
        g_data[(size_t)d.id] = d;
        ...
        reset_data(d, ItemType::ranged_wpn);
        d = g_data[(size_t)ItemId::trap_dart];
        ...
        reset_data(d, ItemType::ranged_wpn);
        d = g_data[(size_t)ItemId::trap_spear];
        ...
        d.melee.hit_chance_mod =
                g_data[(size_t)ItemId::player_kick].melee.hit_chance_mod;
        d.melee.dmg =
                g_data[(size_t)ItemId::player_kick].melee.dmg;
        d.melee.miss_sfx =
                g_data[(size_t)ItemId::player_kick].melee.miss_sfx;
        d.melee.dmg_method = DmgMethod::kicking;
